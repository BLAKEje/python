'''Crie uma classe utilizando os conceitos de POO. Para criar sua classe, pense em uma entidade do mundo real que possa 
ser representada de maneira simples e objetiva.  Por exemplo, uma classe "Pessoa" poderia ter atributos como nome, idade e endereço
e métodos como cumprimentar e se movimentar. Já uma classe "Animal" poderia ter atributos como espécie, peso e altura 
e métodos como andar e dormir.'''
